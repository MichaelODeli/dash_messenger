...
- [Этап app](#этап-app) (12.05-...)


## Этап **app**
### [app 1.1.1905]
- Полная переработка структуры страницы мессенджера
    - Вместо колонок используется таблица
    - Наконец-то нормально работающий скролл без дополнительных элементов
- Добавлено выделение выбранного контакта в списке

### [app 1.0.1605]
- В случае неработоспособности сервера будет происходить редирект на страницу с ошибкой 503.
- Работа авторизации
    - Если клиент авторизован и токен правильный - авторедирект на страницу с мессенджером
- Добавление кнопки выхода в header
- Добавление API метода для верификации токена вне соединения WebSocket
- Loader, блокирующий ввод аутентификационных данных, пока не будет проверен токен


### [app 0.1.1205]
- Переработка roadmap для этапа **app**
